...
const headerVariants = {
    ...
    scrolled: {
        width: 'calc(100% - 2rem)', // Use calc for responsive narrowing
        maxWidth: '1200px', 
        marginTop: '0.5rem',
        borderRadius: '9999px',
...
export function Header() {
  ...
  return (
    <header className="fixed top-0 z-50 flex w-full items-start justify-center">
      <motion.div
        className={cn(
            "flex h-16 items-center justify-between px-4 md:px-6 transition-colors duration-300 border-border border",
